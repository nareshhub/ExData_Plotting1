...
#legend("topright",pch=1,c("Sub_1","Sub_2","Sub_3"),col=c("black","red","green"),cex = 1)
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=1,col=c("black","red","green"),bty="n",x.intersp=0.2, y.intersp=0.3,cex=0.7)
